<template>
  <div>
      ...
      <div class="container">
        <div class="card card-custom overflow-hidden" :style="{ 'border':' 1px solid', 'marginBottom': '20px solid' }">
            ...
            <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
              <div class="col-md-12" :style="{ 'fontSize': '15px !important' }">
                <div class="d-flex justify-content-between">
                  ...
                  >
                    <div :style='{ "float": "left", "width": "100%" }'>
                      <div :style='{ "float": "left", "padding": "10px", "width": "100px" }'>
                        <img src='~/static/img/card/govt-logo.png' width="50px" />
                      </div>
                      <div :style='{ "float": "left", "width": "260px" }'></div>
                      <div :style='{ "float": "right", "padding": "5px", "width": "100px" }'>
                        <img src='~/static/img/card/mujib100.png' width="80px" />
                      </div>
                    </div>
                    <span class="font-weight-bolder" :style='{ "paddingBottom": "10px" }'>
                      কোভিড-১৯ টিকাদান কার্ড
                    </span>
                    <span class="font-weight-bolder">(Covid-19 Vaccination Card)</span>
                    <div :style='{ "float": "left", "width": "460px" }'>
                      <div :style='{ "float": "left", "width": "280px" }'>
                        <label :style='{ "float": "left", "textAlign": "left" }' class="opacity-85">
                          রেজিস্ট্রেশন নং-
                        </label>
                        <div
                          class="opacity-100"
                  ...
                  <div class="d-flex flex-column flex-root col-md-6" :style='{ "padding": "10px" }' align="left">
                    <span
                    ...
                    <div :style='{ "float": "left", "width": "460px" }'>
                      <div :style='{ "float": "left", "padding": "10px", "width": "120px" }'>
                        <img src='~/static/img/card/tika-logo.png' width="70px" />
                      </div>
                      <div :style='{ "float": "left", "width": "220px" }'>
                        <label :style='{ "textAlign": "center", "paddingTop": "10px" }' class="opacity-100">
                      ...
                      <div :style='{ "float": "right", "padding": "10px", "width": "120px" }'>
                        <img src='~/static/img/card/dgh-logo.png' width="100px" />
                      </div>
                    </div>
                    <div :style='{ fontWeight: "bold", "paddingTop": "10px" }' width="460px" align="center">
                      :: সহযোগিতায় ::
                    </div>
                    <div :style='{ "width": "460px" }' align="center">
                      <div :style='{ "width": "100px" }'></div>
                      <div :style='{ "width": "460px" }'>
                        <img src='~/static/img/card/ict-logo.png' width="280px" />
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="opacity-85" :style='{ "padding": "15px 10px 30px 10px", align: "center" }'>
          - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
          - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        </div>

        <div class="card card-custom overflow-hidden" :style='{ border: " 1px solid", marginBottom: "20px" }'>
          <div class="card-body p-0">
            <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
              <div class="col-md-12" :style='{ border: "1px solid", fontSize: "15px" }'>
                <div class="d-flex justify-content-between">
                  <div class="d-flex flex-column flex-root col-md-12" :style='{ "padding": "10px", align: "left" }'>
                    <span
                      class="font-weight-bolder mb-2"
                    ...
                    <div class="opacity-85" :style='{ "padding": "10px 10px 10px 10px" }'></div>
                    ...
                    <div class="opacity-85" :style='{ "padding": "5px 10px 5px 10px" }'></div>
                    ...
                    <div :style='{ "float": "left", "width": "920px" }'>
                      ...
                      <div :style='{ "float": "left", "width": "300px" }'>
                        <label class="opacity-85" :style='{ "float": "left", "textAlign": "left" }'>
                          তারিখ-
                        </label>
                        <div
                          class="opacity-100"
